...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		File archivo = leeArchivo();
		creaFacturaXML(archivo);
	}
	...
	public static File creaArchivo(Scanner sc) throws IOException {
		File archivo = null;
		String nombre;
	...
	public static File leeArchivo() throws IOException {
	...
	public static void creaFacturaXML(File origen) throws IOException {
		Scanner sc = new Scanner(System.in);
		File destino = creaArchivo(sc);
		...
		while ((linea = lector.readLine()) != null) {
			...
			if (dentroDeReserva) {
				if (linea.contains("<nombre>") && !eNombre && linea.endsWith("</nombre>")) {
					bw.write(linea);
					bw.newLine();
					eNombre = true;
				} else if (linea.contains("<fechaEvento>") && !eFechaEvento&& linea.endsWith("</fechaEvento>")) {
					bw.write(linea);
					bw.newLine();
					eFechaEvento = true;
				} else if (linea.contains("<tipo>") && !eTipoEvento&& linea.endsWith("</tipo>")) {
					bw.write(linea);
					bw.newLine();
					eTipoEvento = true;
				} else if (linea.contains("<asistentes>") && !eAsistentes&& linea.endsWith("</asistentes>")) {
					bw.write(linea);
					bw.newLine();
					eAsistentes = true;
				} else if (linea.contains("<tipoCocina>") && !eTipoCocina&& linea.endsWith("</tipoCocina>")) {
					bw.write(linea);
					bw.newLine();
					eTipoCocina = true;
				} else if (linea.contains("<numeroJornadas>") && !eNumeroJornadas&& linea.endsWith("</numeroJornadas>")) {
					bw.write(linea);
					bw.newLine();
					eNumeroJornadas = true;
				} else if (linea.contains("<habitaciones>") && !eHabitaciones&& linea.endsWith("</habitaciones>")) {
					bw.write(linea);
					bw.newLine();
					eHabitaciones = true;
				} else if (linea.contains("<tipoMesa>") && !eTipoMesa&& linea.endsWith("</tipoMesa>")) {
					bw.write(linea);
					bw.newLine();
					eTipoMesa = true;
				} else if (linea.contains("<comensalesMesa>") && !eComensalesMesa&& linea.endsWith("</comensalesMesa>")) {
					bw.write(linea);
					bw.newLine();
					eComensalesMesa = true;
				}
			}
	...
	public static void creaFacturaJSON(File origen) throws IOException {
		Scanner sc = new Scanner(System.in);
		File destino = creaArchivo(sc);
		FileReader fr = new FileReader(origen);
		BufferedReader lector = new BufferedReader(fr);
		...
		while ((linea = lector.readLine()) != null) {
			...
			if (dentroDeReserva) {
				compruebaCampoJSON(linea, "nombre", "\"nombre\":", bw);
				compruebaCampoJSON(linea, "fechaEvento", "\"fechaEvento\":", bw);
				compruebaCampoJSON(linea, "tipo", "\"tipo\":", bw);
				compruebaCampoJSON(linea, "asistentes", "\"asistentes\":", bw);
				compruebaCampoJSON(linea, "tipoCocina", "\"tipoCocina\":", bw);
				compruebaCampoJSON(linea, "numeroJornadas", "\"numeroJornadas\":", bw);
				compruebaCampoJSON(linea, "habitaciones", "\"habitaciones\":", bw);
				compruebaCampoJSON(linea, "tipoMesa", "\"tipoMesa\":", bw);
				compruebaCampoJSON(linea, "comensalesMesa", "\"comensalesMesa\":", bw);
			}
	...
	public static void compruebaCampoJSON(String linea, String etiqueta, String sustituto, BufferedWriter bw)
			throws IOException {
